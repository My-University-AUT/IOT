...
//     Serial1.print("Weight in KG:\t");
//     const int foodWeight = scale.get_units() / 1000;
//     Serial1.println(foodWeight);
//     const bool timeToFillPlate = checkTimeToFillPlate();
//     if (timeToFillPlate && foodWeight < 2)
//     {
//         turnOnBuzzer();
//         fillThePlate();
//         turnOffBuzzer();
//         Serial1.println("filling by servo");
//     }
//     delay(1000);
// }
